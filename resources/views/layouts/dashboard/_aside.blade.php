<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
           <li><a href=""><i class="fa fa-th"></i><span>@lang('site.home')</span></a></li>

            {{-- @if (auth()->user()->hasPermission('read_categories')) --}}
                <li><a href="{{route('admin.categories')}}"><i class="fa fa-th"></i><span>@lang('site.categories')</span></a></li>
            {{-- @endif --}}

            {{-- @if (auth()->user()->hasPermission('read_products')) --}}
                <li><a href="{{route('admin.products')}}"><i class="fa fa-th"></i><span>@lang('site.products')</span></a></li>
            {{-- @endif --}}
